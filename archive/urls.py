...
urlpatterns = patterns('',
    ...
    url(r'^users/username/$', 'hnec.views.users.checkUsername'),
    ...
    url(r'^editArchiveEditable/$','hnec.views.archive.editArchiveEditable'),
    url(r'^editFolder/$', 'hnec.views.department.editFolder'),
    url(r'^deletFolder/$', 'hnec.views.department.deletFolder'),
    url(r'^addSection/$', 'hnec.views.department.addSection'),
    ...
    url(r'^deleteFile/(?P<file_id>\d+)/$','hnec.views.archive.deleteFile'),
    url(r'^deleteArchive/(?P<archive_id>\d+)/$','hnec.views.archive.deleteArchive'),
